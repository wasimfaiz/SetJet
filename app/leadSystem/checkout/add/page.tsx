...
const CheckoutAddPageContent = () => {
  ...
  const handleFormSubmit = async (data: { [key: string]: any }) => {
    try {
      ...
      const url = initialData ? `/api/checkout?id=${id}` : "/api/checkout";
...
const CheckoutAddPage = () => {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <CheckoutAddPageContent />
    </Suspense>
  );
};

export default CheckoutAddPage;
