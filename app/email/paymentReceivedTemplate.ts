...
<div class="wrapper">
  ...
  <div class="body-padding" style="padding:50px 60px 40px;">
    ...
    <p style="color:#374151;font-size:16px;line-height:1.7;margin-bottom:20px;">
      Your payment for <strong>${serviceName}</strong> has been received successfully.  
    ...
    <table role="presentation" width="100%"
      ...
      <tr>
        <td style="padding:10px;font-weight:600;color:#1e3a8a;">Amount Paid</td>
    ...
    <p style="color:#374151;font-size:16px;margin-bottom:30px;">
      Thank you for choosing <strong>YAStudy</strong>.  
